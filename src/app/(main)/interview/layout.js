    ...
    >
      ...
      >
        ...
        <span className="text-white/40 text-sm">
          Loading your interview assessments...
        </span>
      </motion.div>
    </motion.div>
  );
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative p-3 rounded-xl bg-gradient-to-br from-indigo-500/20 to-cyan-500/20 border border-white/10">
            ...
            <div>
              ...
              >
                Practice interviews and track your performance with AI feedback
              </motion.p>
            </div>
          </div>
          ...
          >
            ...
            <span className="text-white/60 text-sm">AI Coaching</span>
          </motion.div>
        </motion.div>
